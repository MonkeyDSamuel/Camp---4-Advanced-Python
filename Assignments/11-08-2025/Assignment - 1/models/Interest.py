'''
1. 
    A bank has two kinds of accounts, savings and fixed deposit. 
    The interest rates for these are 4% and 11% respectively.
    Customer account interest needs to be implemented.
    Implement a solution to print the interest on the basis of principal, time, & rate given by the user.
    Design an appropriate class and method to implement this.
